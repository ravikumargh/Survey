...
angular.module('yeomanApp').controller('TeamModalInstanceCtrl', function ($scope, $uibModalInstance, parentScope) {
...
angular.module('yeomanApp').controller('TeamDeleteConfirmationModalInstanceControl', function ($scope, $uibModalInstance, parentScope) {
